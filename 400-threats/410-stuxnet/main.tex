...
\begin{tikzpicture}[scale=0.9]
    ...
    % Events
    \node[fill=warning!30, rounded corners, font=\scriptsize, align=center, anchor=south] at (1,0.3) {Development\\begins};
    \node[fill=danger!30, rounded corners, font=\scriptsize, align=center, anchor=south] at (4,0.3) {First infections\\detected};
    \node[fill=danger!30, rounded corners, font=\scriptsize, align=center, anchor=south] at (7,0.3) {Major variant\\deployed};
    \node[fill=info!30, rounded corners, font=\scriptsize, align=center, anchor=south] at (10,0.3) {Publicly\\discovered};
    \node[fill=success!30, rounded corners, font=\scriptsize, align=center, anchor=south] at (12,0.3) {Analysis\\complete};
\end{tikzpicture}
\end{center}
